...
#ifdef	USEAXL
   websocket_callback_xml_t *callbackxml;
   websocket_callback_xmlraw_t *callbackxmlraw;
#endif
#ifdef	USEAJL
   websocket_callback_json_t *callbackjson;
   websocket_callback_jsonraw_t *callbackjsonraw;
#endif
};
